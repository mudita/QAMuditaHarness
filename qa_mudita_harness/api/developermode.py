...
class PhoneModeLock(GenericTransaction):
    ...
    def __init__(self, enable: bool):
        ...
        self.request = Request(
            Endpoint.DEVELOPERMODE, Method.PUT, {"phoneLockCodeEnabled": enable}
        )
...
class SetLog(GenericTransaction):
    ...
    def __init__(self, service: str, level: PureLogLevel):
        self.request = Request(
            ...
            Method.PUT,
            {"log": True, "service": service, "level": level.value},
        )
...
class GetLog(GenericTransaction):
    ...
    def __init__(self, service: str, level: PureLogLevel):
        self.request = Request(
            Endpoint.DEVELOPERMODE, Method.GET, {"log": True, "service": service}
        )
...
class SetEQ(GenericTransaction):
    ...
    def __init__(self, file_name: str, file_data: str):
        self.request = Request(
            Endpoint.DEVELOPERMODE,
            Method.PUT,
            {"EQ": "test", "fileName": file_name, "fileData": file_data},
        )
